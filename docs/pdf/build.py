...
def manual(story):
    ...
    story += [H1("Before you start"),
              ...
              P("Each card says one of four things about access. <b>Open</b> means click it and go. <b>Request access</b> sends a request to your lead with one click. <b>View</b> means you can read about it but your role doesn't use it. <b>Contract</b> means another team runs it and the page says who to ask."),
              H1("3. A listing page"),
              ...
              H1("8. If you sign components off"),
              ...
              table([["If", "Then"], ["You can't see a service you need", "Use the request button on its card or page; your lead approves it"], ["An answer looks wrong", "Answer the feedback question with no, open the cited page, or use the handoff to reach a person"],
                     ["You want to propose something", "Build, then start a brief"], ["You're a champion and stuck", "The champions channel, or the office hour named in the hub's footer"],
