...
export const COLLECTION_GUIDE: GuidePassage[] = [
 ...
 },
 {
  ...
  "kind": "page",
  "text": "oad balancer's health check pointed at the readiness route; a scheduled task that runs the backup command and copies the file off the volume |"
 },
 {
 ...
 },
 {
  ...
  "kind": "page",
  "text": "E | `services/*/tests/test_ops.py`; `scripts/smoke-container-tree.sh` hits `/ready` in both trees | The backup job and the alarm on `/ready` created on the bank's account (integrations engineer) |\n| Demonstration video tooling (`demo/`) | OPTIONAL | needs ffmpeg and Chromium; excluded from the bundle | — |"
 },
 {
