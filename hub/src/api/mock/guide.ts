...
export const COLLECTION_GUIDE: GuidePassage[] = [
 ...
 },
 {
  ...
  "kind": "page",
  "text": "image digests pinned by the bank; vendored files checked byte for byte | `services/vendor.py`, `tools/shelf.py --check`, `deploy/Dockerfile` |"
 },
 {
  "id": "SECURITY.md#4",
  "source": "SECURITY.md",
