...
```json
{
  ...
  "tools": [
    {"target": "tickets", "op": "get", "tier": "R", "contract": "tickets.get", "permission": "tickets:read",
     "args": {"key": {"type": "str", "required": true}}, "result": {"key": "id", "summary": true, "description": true, "status": "id"},
     "classes": "internal", "note": "the incident ticket: summary and description, projected and masked before the model sees them"},
