...
class Settings:
    ...
    def from_env(cls, prefix: str = "HUB_") -> "Settings":
        ...
        return cls(env=e("ENV", d.env), auth=e("AUTH", d.auth), listen_host=e("LISTEN_HOST", d.listen_host), listen_port=int(e("LISTEN_PORT", str(d.listen_port))),
                   ...
                   collection_file=e("COLLECTION_FILE", d.collection_file), static_dir=e("STATIC_DIR", ""), kb_url=e("KB_URL", d.kb_url),
    ...
    def validate(self) -> list[str]:
        ...
        for name, path in (("IDENTITY_MAP", self.identity_map), ("CONSUMERS_FILE", self.consumers_file), ("COLLECTION_FILE", self.collection_file)):
