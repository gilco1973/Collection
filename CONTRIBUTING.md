...
8. **Provenance and the specification.** `source` names the project and snapshot; `spec` names the platform design
...
python3 tools/shelf.py --write && python3 tools/shelf.py --test --only python
```
