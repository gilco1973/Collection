#!/usr/bin/env python3
"""Pixel-diff each <Screen>.ref.png against <Screen>.app.png in the compare directory (screens from screens.json).
...
CMP = os.environ.get("OUT", os.path.join(os.getcwd(), "compare"))
SCREENS = [s["name"] for s in json.load(open(os.environ.get("SCREENS", os.path.join(os.getcwd(), "screens.json"))))]
