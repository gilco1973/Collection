...
whose id is in DARK render as full-bleed title cards. `example_slides.py` is a five-slide example.
"""
from __future__ import annotations
import html, importlib.util, json, os, sys

W, H = 1280, 720
DARK = ("title", "never", "start", "end")
...
.dark ul{top:330px;width:1000px;font-size:22px}.dark ul li:before{background:#e0b98a}
.shot{position:absolute;right:48px;top:140px;width:700px;height:520px;border-radius:10px;overflow:hidden;box-shadow:0 8px 30px rgba(0,0,0,.18);background:#fff;border:1px solid #d5dbe3}
...
def build(plan, out_html: str = "deck.html", narration_dir: str = "narration"):
    SLIDES, TITLE, FOOT = plan.SLIDES, plan.TITLE, plan.FOOT
